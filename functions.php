...
function create_post_type_haircatalog() {
	$labels = array(
		'name'                => 'ヘアーカタログ',
		'all_items'           => 'カタログ一覧',
	);
	...
	register_post_type( 'haircatalog', $args );
}
...
function my_scripts() {
    ...
    wp_enqueue_style( 'google-webfont-style', '//fonts.googleapis.com/css?family=Comfortaa|Oswald|Shadows+Into+Light' );
		wp_enqueue_style( 'google-webfont-style', '//fonts.googleapis.com/earlyaccess/notosansjp.css?family=Noto Sans JP' );
		wp_enqueue_style( 'google-webfont-style', '//fonts.googleapis.com/css?family=Open+Sans|Roboto+Mono|Shadows+Into+Light' );
}
add_action( 'wp_enqueue_scripts', 'my_scripts' );

//slick
// function enqueue_style() {
// 	wp_enqueue_style( 'slick_jquery_ui', '/slick/slick.min.js' );
// 	wp_enqueue_style( 'slick' , get_stylesheet_directory_uri() . '/slick/slick.css', array('slick_jquery_ui' ) );
// 	wp_enqueue_style( 'slick' , get_stylesheet_directory_uri() . '/slick/slick-theme.css', array('slick_jquery_ui' ) );
// }
